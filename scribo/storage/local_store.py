...
Saves lecture assets into a structured course hierarchy:
  ...
  data/courses/<course_id>/lecture_<lecture_id>_transcript.txt  # Raw verbatim transcript
...
def save_lecture(
    ...
    Args:
        ...
        transcript_content: Optional raw verbatim transcript text.
...
def save_transcript_only(
    ...
    """Save raw transcript file independently."""
    course_dir = get_course_dir(course_id)
    safe_lecture_id = lecture_id.strip().lower().replace(" ", "_")
